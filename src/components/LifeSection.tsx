    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a href={SITE_META.emailHref} style={{ color: 'var(--gold)', opacity: 0.7, textDecoration: 'none' }}>
            {SITE_META.email}
          </a>
        </div>
      </div>
      ...
      <section ref={ref} style={{
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 16, marginBottom: 20 }}>
          ...
          <h2 style={{
            ...
            <em style={{ color: 'var(--gold)', fontStyle: 'italic' }}>{SECTION_HEADERS.life.em}</em>
          </h2>
        ...
        <p style={{
          ...
          fontSize: 'clamp(14px, 2vw, 17px)', lineHeight: 1.85,
          color: 'var(--text)', opacity: 0.72, maxWidth: 520, marginBottom: 44,
        }}>
        ...
        <div style={{
          ...
          {HOBBIES.map(h => <HobbyCard key={h.name} hobby={h} />)}
        </div>
      </section>
    </>
  );
  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLDivElement).style.borderColor = h.color;
      }}
      onMouseLeave={e => {
